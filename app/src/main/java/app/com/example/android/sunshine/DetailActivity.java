...
public class DetailActivity extends ActionBarActivity {
    ...
    public static class ShareFragment extends Fragment {
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
           ...
           mShareActionProvider =
            ...
            if (mShareActionProvider != null) {
                mShareActionProvider.setShareIntent(this.createShareForecastIntent());
        ...
        public Intent createShareForecastIntent() {
            ...
            StringBuilder extra_textStrBldr = new StringBuilder();
            extra_textStrBldr.append(mForecastStr);
            extra_textStrBldr.append(FORECAST_SHARE_HASH_TAG);

            shareIntent.putExtra(Intent.EXTRA_TEXT,extra_textStrBldr.toString());
